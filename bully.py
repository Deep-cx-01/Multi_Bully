...
class Bully(nn.Module):
    def __init__(self,n_out):
        ...
        self.bully_128 = nn.Linear(256,128)
        self.bully_out = nn.Linear(256,n_out)
   ...
   #remove below comments accordingly as per the type of attention you want to give.
        ...
        #emoti_a = self.bully_256(concat)
        #emoti_b = self.bully_128(emoti_a)
        #emoti_out = self.out(emoti_b)
        
        
        return concat,bully_a,bully_b,bully_out
